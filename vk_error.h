...
#pragma region [ Vulkan Error Handling Functions ]
// Taken from IskaneOnReddit: https://www.reddit.com/r/vulkan/comments/zxgst4/is_here_a_way_to_turn_vkresult_into_c_string/
static const char* VkResultToCString(VkResult result)
{
    switch (result)
    {
...
static const char* VkColorSpaceToString(VkColorSpaceKHR cs)
{
    switch (cs)
    {
